...
let lemma_inv_implies_agreement s =
  ...
  with _pf. begin
    ...
    // CS.supported_profile_application_record_material_agrees s.client s.server
    // unfolds definitionally to the two peer_record_material_agrees conjuncts.
    assert (CS.supported_profile_application_record_material_agrees s.client s.server)
  end

...
let lemma_paired_protected_handshake_event_projection_pair_witnesses_from_staged_replays_v2
  (client_state:connection_state)
  (server_state:connection_state)
  (server_flight_sender:connection_model)
  (server_flight_receiver:connection_model)
  ...
  (server_final:connection_model)
  (client_final:connection_model)
  (client_finished_write_install_source:connection_model)
  (client_finished_read_install_source:connection_model)
  (client_finished_client_write_material:traffic_key_material)
  (client_finished_server_read_material:traffic_key_material)
  (client_finished_sender:connection_model)
  (client_finished_receiver:connection_model)
  (cf_client_after_verify:connection_model)
  (cf_client_after_app_write:connection_model)
...
let lemma_paired_protected_handshake_event_projection_pair_witnesses_from_installed_server_flight_replays
  (client_state:connection_state)
  (server_state:connection_state)
  (server_flight_sender:connection_model)
  (server_flight_receiver:connection_model)
  ...
  (server_finished_final:connection_model)
=
  lemma_protected_handshake_event_projection_pairs_server_encrypted_flight_after_installs_with_tails
    server_flight_sender
    server_flight_receiver
    server_after0
    client_after0
  ...
  eliminate exists
    ...
    (client_tail_sent:B.bytes)
    (client_tail_received:B.bytes).
    pair0.pm_sender == server_flight_sender /\
    pair0.pm_receiver == server_flight_receiver /\
    protected_handshake_event_projection_pair
      pair0
      sent_msg0
      received_msg0 /\

...
let protected_handshake_event_projection_pair
  ...
  (match
    TLS13.Spec.StateMachine.KeyMaterial.record_direction_material pair.pm_sender.CS.model_record.CS.record_write,
    TLS13.Spec.StateMachine.KeyMaterial.record_direction_material pair.pm_receiver.CS.model_record.CS.record_read
  with
  | Some sender_write, Some receiver_read ->
    TLS13.Spec.StateMachine.KeyMaterial.record_key_iv_material_agrees sender_write receiver_read
  | _, _ ->

...
(**
  Stage 2 of the server-flight derivation: discharge the
  [SCShape.log_has_no_received_ccs] hypothesis relied upon by
  [TLS13.ConnectionState.ServerCanonicalShape] directly from the flagship JOINT
...
val lemma_no_received_ccs_from_pairing

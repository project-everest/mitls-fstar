...
val lemma_protected_handshake_event_projection_pair_after_server_write_client_read_install_receiver_preserve_read_local_head_with_tails
  (server:CS.connection_model)
  (client:CS.connection_model)
  ...
  : Lemma
      ...
      (ensures
        exists server_after client_after client_after_skip
          ...
          CS.step_model client_after (CS.ConnLocalEvent receiver_skip) ==
...
val lemma_protected_handshake_event_projection_pair_after_server_write_receiver_preserve_read_local_head_client_read_install_with_tails
  (server:CS.connection_model)
  (client:CS.connection_model)
  (receiver_skip:CS.local_event)
  (server_material:CS.traffic_key_material)
  ...
  : Lemma
      (requires
        ...
        TLS13.Spec.StateMachine.Replay.conn_events_received_decode_replay
          client
          (CS.ConnLocalEvent receiver_skip :: CS.ConnLocalEvent
            (CS.LocalInstallTrafficKeys {
              CS.install_epoch = CS.TrafficHandshake;
              CS.install_direction = CS.TrafficRead;
              CS.install_material = client_material;
      ...
      (ensures
        exists server_after client_after_skip client_after
          ...
          CS.step_model client (CS.ConnLocalEvent receiver_skip) ==
            Some client_after_skip /\
          CS.step_model
            client_after_skip
            (CS.ConnLocalEvent
...
val lemma_protected_handshake_event_projection_pair_after_sender_preserve_write_local_head_server_write_receiver_preserve_read_local_head_client_read_install_with_tails
  (server:CS.connection_model)
  (client:CS.connection_model)
  (sender_skip:CS.local_event)
  (server_after_skip:CS.connection_model)
...
val lemma_protected_handshake_event_projection_pairs_server_encrypted_flight_after_installs_with_tails
  (server:CS.connection_model)
  (client:CS.connection_model)
  (server_after0:CS.connection_model)
  (client_after0:CS.connection_model)
  ...
  : Lemma
      (requires
        ...
        server_after0.CS.model_record.CS.record_write ==
          R.next_seq server.CS.model_record.CS.record_write /\
        client_after0.CS.model_record.CS.record_read ==
          R.next_seq client.CS.model_record.CS.record_read /\
        CS.step_model
          server_after0
          (CS.ConnNetworkEvent {
            CL.message_direction = CL.Sent;
...
val lemma_server_encrypted_flight_after_installs_preserves_client_write_server_read_alignment
  (server:CS.connection_model)
  (client:CS.connection_model)
  (server_after0:CS.connection_model)
  (client_after0:CS.connection_model)

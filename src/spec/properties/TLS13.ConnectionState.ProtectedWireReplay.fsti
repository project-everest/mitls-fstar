  ...
  : Lemma
      ...
      (ensures
        exists model1 delta_sent delta_received tail_sent tail_received.
          ...
          CS.step_model model ev == Some model1 /\
          CS.event_raw_delta_legal model ev delta_sent delta_received /\
          TLS13.Spec.StateMachine.Canonical.sent_event_nonempty_seal_projection model ev delta_sent /\
          Seq.equal raw_sent (B.append delta_sent tail_sent) /\
          Seq.equal raw_received (B.append delta_received tail_received) /\
          TLS13.Spec.StateMachine.Replay.conn_events_sent_seal_replay
            model1
...
val lemma_conn_events_sent_seal_replay_cons
  (model:CS.connection_model)
  (ev:CS.conn_event)
  (rest:list CS.conn_event)
  (raw_sent:B.bytes)
  ...
  : Lemma
      ...
      (ensures
        exists model1 delta_sent delta_received tail_sent tail_received.
          ...
          CS.step_model model ev == Some model1 /\
          CS.event_raw_delta_legal model ev delta_sent delta_received /\
          TLS13.Spec.StateMachine.Canonical.received_event_nonempty_decode_projection model ev delta_received /\
          Seq.equal raw_sent (B.append delta_sent tail_sent) /\
          Seq.equal raw_received (B.append delta_received tail_received) /\
          TLS13.Spec.StateMachine.Replay.conn_events_received_decode_replay
            model1
...
val lemma_conn_events_received_decode_replay_cons
  (model:CS.connection_model)
  (ev:CS.conn_event)
  (rest:list CS.conn_event)
  (raw_sent:B.bytes)
...
val lemma_conn_events_sent_seal_replay_implies_raw_replay
  (model:CS.connection_model)
  (events:list CS.conn_event)
  (raw_sent:B.bytes)
  (raw_received:B.bytes)
...
val lemma_conn_events_received_decode_replay_implies_raw_replay
  (model:CS.connection_model)
  (events:list CS.conn_event)
  (raw_sent:B.bytes)
  (raw_received:B.bytes)

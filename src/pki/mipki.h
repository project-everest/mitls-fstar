...
int mipki_sign_verify(mipki_chain cert_ptr, const mipki_signature sigalg, const char *tbs, size_t tbs_len, char *sig, size_t *sig_len, mipki_mode m);
mipki_chain mipki_parse_chain(const char *chain, size_t chain_len);
size_t mipki_format_chain(mipki_chain chain, char *buffer, size_t buffer_len);
int mipki_validate_chain(mipki_chain chain, const char *host);

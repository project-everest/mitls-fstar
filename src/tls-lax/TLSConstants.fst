...
val versionBytes : PreProtocolVersion -> Tot (lbytes 2)
let versionBytes pv =
    match pv with
...
val macAlg_of_aeAlg: (pv:ProtocolVersion) -> (a:aeAlg { is_MtE a \/ (is_SSL_3p0 pv /\ is_MACOnly a) }) -> Tot macAlg
...
val seq_of_bytes: b:bytes{ length b <= 4 } -> Tot nat

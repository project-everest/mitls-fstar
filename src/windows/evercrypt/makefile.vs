...
libevercrypt.dll: libevercrypt_code.lib libevercrypt.def dllmain.obj ../krmllib/libkrmllib.lib
  link /nologo /dll /debug:full /out:libevercrypt.dll ../krmllib/libkrmllib.lib libevercrypt_code.lib dllmain.obj /def:libevercrypt.def /OPT:ICF /OPT:REF ntdll.lib bcrypt.lib

...
noextract
let rec enum_repr_of_key_tac_new
  (#key #repr: eqtype)
  (e: enum key repr)
  (u: unit  { Cons? e } )
  ()
...
= match e with
  ...
  | _ :: e' ->
    ...
    T.apply fu;
    T.iseq [
      (fun () -> enum_repr_of_key_tac_new e' () ());
      (fun () -> T.exact_guard (quote ()); conclude ());
    ]
...
noextract
let parse32_maybe_enum_key_tac_new
  (#k: parser_kind)
  (#key #repr: eqtype)
  (#p: parser k repr)
  (p32: parser32 p)
...
= let fu = quote (parse32_maybe_enum_key_gen #k #key #repr #p p32 e #k' p' u) in
  T.apply fu;
  T.iseq [
    (fun () -> maybe_enum_key_of_repr_tac_new #key #repr e ());
  ]
...
= let fu = quote (parse32_enum_key_gen #k #key #repr p e #k' p' u) in
  T.apply fu;
  T.iseq [
    (fun () -> parse32_maybe_enum_key_tac_new p32 e (parse_maybe_enum_key p e) () ())
  ]
...
noextract
let serialize32_enum_key_gen_tac_new
  (#k: parser_kind)
  (#key #repr: eqtype)
  (#p: parser k repr)
  (#s: serializer p)
...
noextract
let serialize32_maybe_enum_key_tac_new
  (#k: parser_kind)
  (#key #repr: eqtype)
  (#p: parser k repr)
  (#s: serializer p)

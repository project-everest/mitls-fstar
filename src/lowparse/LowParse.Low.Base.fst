...
let print_list
  ...
  (#p: parser k t)
  (j: jumper p)
  (print: ((#rrel: B.srel byte) -> (#rel: B.srel byte) -> (sl: slice rrel rel) -> (pos: U32.t) -> HST.Stack unit (requires (fun h -> valid p h sl pos)) (ensures (fun h _ h' -> B.modifies B.loc_none h h'))))
  (#rrel #rel: B.srel byte)
  (sl: slice rrel rel)
  (pos pos' : U32.t)
: HST.Stack unit

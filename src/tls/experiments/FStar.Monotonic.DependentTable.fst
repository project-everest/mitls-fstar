...
let grows #a #b #inv rel m1 m2 = grows' #a #b #inv rel m1 m2
*)

let defined_stable #a #b #inv #rel #r t x = ()

let contains_stable #a #b #inv #rel #r t x y p p_stable_on_r = ()

////////////////////////////////////////////////////////////////////////////////

//The main stateful interface is minimal and straigtforward
let alloc #a #b #inv #rel #r _ = ralloc r []

let update #a #b #inv #rel #r t x y =
  recall t;
  let cur = !t in
  t := upd cur x y;
  witness_p t (defined t x)

let lookup #a #b #inv #rel #r t x =
  let m = !t in
  let y = sel m x in
  match y with
  | None -> y
...
let map_f #a #b #c #inv #inv' #rel #rel' #r #r' t f
  = let m = !t in
    ralloc r' (mmap_f m f)

let map_stable #a #b #inv #rel #r t p p_stable = ()

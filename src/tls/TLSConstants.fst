...
let extract_string = "master secret"
...
/// 18-02-24 missing lenght bounds:
...
let rec string_of_quicParameters_aux_fold #t a (f: t -> string) sep (p: list t): Tot string (decreases p) =
  match p with
  | [] -> a

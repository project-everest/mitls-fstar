...
extern void * FFI_mitls_prepare_send13(/* in out */ size_t *state, const void* buffer, size_t buffer_size, /* out */ size_t *packet_size); // Returns NULL for failure, or a TCP packet to be sent then freed with FFI_mitls_free_packet()
extern void * FFI_mitls_handle_receive13(/* in out */ size_t *state, char* header, size_t header_size, char *record, size_t record_size, /* out */ size_t *packet_size);     // Returns NULL for failure, a plaintext packet to be freed with FFI_mitls_free_packet()

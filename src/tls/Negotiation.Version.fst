...
#push-options "--query_stats --z3rlimit 100" // 19-01-04 too slow? note the refinement on the length of the inner lists. 
(*
...
// Alternative code, easier to refine and extract; worth the trouble? 
private let cons_supported cfg pv pvs = if supported cfg pv then pv::pvs else pvs 
...
private let offered_version o = o.HandshakeMessages.ch_protocol_version 
private let offered_extensions o = o.HandshakeMessages.ch_extensions 

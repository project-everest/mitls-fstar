...
open MiTLS.CoreCrypto          // for algorithm names, and key, IV, tag lengths

open MiTLS.TLSConstants        // for explicit IV length
open MiTLS.TLSInfo
module Range = MiTLS.Range
let range = Range.range
open MiTLS.LHAEPlain

...
let css = [
  ...
  ("ECDHE-RSA-AES256-GCM-SHA2_384", TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384);
  ("ECDHE-RSA-AES128-GCM-SHA2_256", TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256);
  ("ECDHE-RSA-CHACHA20-POLY1305-SHA2_256", TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256);
  ("ECDHE-ECDSA-AES256-GCM-SHA2_384", TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384);
  ("ECDHE-ECDSA-AES128-GCM-SHA2_256", TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256);
  ("ECDHE-ECDSA-CHACHA20-POLY1305-SHA2_256", TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256);
  ("DHE-RSA-AES256-GCM-SHA2_384", TLS_DHE_RSA_WITH_AES_256_GCM_SHA384);
  ("DHE-RSA-AES128-GCM-SHA2_256", TLS_DHE_RSA_WITH_AES_128_GCM_SHA256);
  ("DHE-RSA-CHACHA20-POLY1305-SHA2_256", TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256);
]

let sas = [
  ("RSAPSS+SHA2_512", RSA_PSS_SHA512);
  ("RSAPSS+SHA2_384", RSA_PSS_SHA384);
  ("RSAPSS+SHA2_256", RSA_PSS_SHA256);
  ("RSA+SHA2_512",    RSA_PKCS1_SHA512);
  ("RSA+SHA2_384",    RSA_PKCS1_SHA384);
  ("RSA+SHA2_256",    RSA_PKCS1_SHA256);
  ("RSA+SHA1",      RSA_PKCS1_SHA1);
  ("ECDSA+SHA2_512",  ECDSA_SECP521R1_SHA512);
  ("ECDSA+SHA2_384",  ECDSA_SECP384R1_SHA384);
  ("ECDSA+SHA2_256",  ECDSA_SECP256R1_SHA256);

...
// WSR.lemma_certificate_verify_context_index_eq k reveals:
//   cv_context_index k == (match k with | 0 -> 0x54uy | ... | _ -> 0uy)
// For concrete k in a match arm, Z3 evaluates the nat-match via simple
// equality chains — no recursive List.Tot.index fuel needed.
...
=
  ...
  match iv with
  | 0  -> WSR.lemma_certificate_verify_context_index_eq  0; lemma_sizet_eq_of_v i  0sz; assert_norm (cv_context_byte  0sz == 0x54uy)
  | 1  -> WSR.lemma_certificate_verify_context_index_eq  1; lemma_sizet_eq_of_v i  1sz; assert_norm (cv_context_byte  1sz == 0x4cuy)
  | 2  -> WSR.lemma_certificate_verify_context_index_eq  2; lemma_sizet_eq_of_v i  2sz; assert_norm (cv_context_byte  2sz == 0x53uy)
  | 3  -> WSR.lemma_certificate_verify_context_index_eq  3; lemma_sizet_eq_of_v i  3sz; assert_norm (cv_context_byte  3sz == 0x20uy)
  | 4  -> WSR.lemma_certificate_verify_context_index_eq  4; lemma_sizet_eq_of_v i  4sz; assert_norm (cv_context_byte  4sz == 0x31uy)
  | 5  -> WSR.lemma_certificate_verify_context_index_eq  5; lemma_sizet_eq_of_v i  5sz; assert_norm (cv_context_byte  5sz == 0x2euy)
  | 6  -> WSR.lemma_certificate_verify_context_index_eq  6; lemma_sizet_eq_of_v i  6sz; assert_norm (cv_context_byte  6sz == 0x33uy)
  | 7  -> WSR.lemma_certificate_verify_context_index_eq  7; lemma_sizet_eq_of_v i  7sz; assert_norm (cv_context_byte  7sz == 0x2cuy)
  | 8  -> WSR.lemma_certificate_verify_context_index_eq  8; lemma_sizet_eq_of_v i  8sz; assert_norm (cv_context_byte  8sz == 0x20uy)
  | 9  -> WSR.lemma_certificate_verify_context_index_eq  9; lemma_sizet_eq_of_v i  9sz; assert_norm (cv_context_byte  9sz == 0x73uy)
  | 10 -> WSR.lemma_certificate_verify_context_index_eq 10; lemma_sizet_eq_of_v i 10sz; assert_norm (cv_context_byte 10sz == 0x65uy)
  | 11 -> WSR.lemma_certificate_verify_context_index_eq 11; lemma_sizet_eq_of_v i 11sz; assert_norm (cv_context_byte 11sz == 0x72uy)
  | 12 -> WSR.lemma_certificate_verify_context_index_eq 12; lemma_sizet_eq_of_v i 12sz; assert_norm (cv_context_byte 12sz == 0x76uy)
  | 13 -> WSR.lemma_certificate_verify_context_index_eq 13; lemma_sizet_eq_of_v i 13sz; assert_norm (cv_context_byte 13sz == 0x65uy)
  | 14 -> WSR.lemma_certificate_verify_context_index_eq 14; lemma_sizet_eq_of_v i 14sz; assert_norm (cv_context_byte 14sz == 0x72uy)
  | 15 -> WSR.lemma_certificate_verify_context_index_eq 15; lemma_sizet_eq_of_v i 15sz; assert_norm (cv_context_byte 15sz == 0x20uy)
  | 16 -> WSR.lemma_certificate_verify_context_index_eq 16; lemma_sizet_eq_of_v i 16sz; assert_norm (cv_context_byte 16sz == 0x43uy)
  | 17 -> WSR.lemma_certificate_verify_context_index_eq 17; lemma_sizet_eq_of_v i 17sz; assert_norm (cv_context_byte 17sz == 0x65uy)
  | 18 -> WSR.lemma_certificate_verify_context_index_eq 18; lemma_sizet_eq_of_v i 18sz; assert_norm (cv_context_byte 18sz == 0x72uy)
  | 19 -> WSR.lemma_certificate_verify_context_index_eq 19; lemma_sizet_eq_of_v i 19sz; assert_norm (cv_context_byte 19sz == 0x74uy)
  | 20 -> WSR.lemma_certificate_verify_context_index_eq 20; lemma_sizet_eq_of_v i 20sz; assert_norm (cv_context_byte 20sz == 0x69uy)
  | 21 -> WSR.lemma_certificate_verify_context_index_eq 21; lemma_sizet_eq_of_v i 21sz; assert_norm (cv_context_byte 21sz == 0x66uy)
  | 22 -> WSR.lemma_certificate_verify_context_index_eq 22; lemma_sizet_eq_of_v i 22sz; assert_norm (cv_context_byte 22sz == 0x69uy)
  | 23 -> WSR.lemma_certificate_verify_context_index_eq 23; lemma_sizet_eq_of_v i 23sz; assert_norm (cv_context_byte 23sz == 0x63uy)
  | 24 -> WSR.lemma_certificate_verify_context_index_eq 24; lemma_sizet_eq_of_v i 24sz; assert_norm (cv_context_byte 24sz == 0x61uy)
  | 25 -> WSR.lemma_certificate_verify_context_index_eq 25; lemma_sizet_eq_of_v i 25sz; assert_norm (cv_context_byte 25sz == 0x74uy)
  | 26 -> WSR.lemma_certificate_verify_context_index_eq 26; lemma_sizet_eq_of_v i 26sz; assert_norm (cv_context_byte 26sz == 0x65uy)
  | 27 -> WSR.lemma_certificate_verify_context_index_eq 27; lemma_sizet_eq_of_v i 27sz; assert_norm (cv_context_byte 27sz == 0x56uy)
  | 28 -> WSR.lemma_certificate_verify_context_index_eq 28; lemma_sizet_eq_of_v i 28sz; assert_norm (cv_context_byte 28sz == 0x65uy)
  | 29 -> WSR.lemma_certificate_verify_context_index_eq 29; lemma_sizet_eq_of_v i 29sz; assert_norm (cv_context_byte 29sz == 0x72uy)
  | 30 -> WSR.lemma_certificate_verify_context_index_eq 30; lemma_sizet_eq_of_v i 30sz; assert_norm (cv_context_byte 30sz == 0x69uy)
  | 31 -> WSR.lemma_certificate_verify_context_index_eq 31; lemma_sizet_eq_of_v i 31sz; assert_norm (cv_context_byte 31sz == 0x66uy)
  | 32 -> WSR.lemma_certificate_verify_context_index_eq 32; lemma_sizet_eq_of_v i 32sz; assert_norm (cv_context_byte 32sz == 0x79uy)
  | _  -> WSR.lemma_certificate_verify_context_index_eq 33; lemma_sizet_eq_of_v i 33sz; assert_norm (cv_context_byte 33sz == 0uy)
...
assume val c_stub_serialize_protected_handshake_record :
  ...
  stt
    (n:SZ.t{SZ.v n <= SZ.v network_out_len})
...
noextract fn serialize_protected_handshake_record
  (#msg: erased M.handshake_msg)
  (write_state: Rec.record_state)
  (handshake: array U8.t)
  (handshake_len: SZ.t)
          ...
          pure (B.length network_bytes == SZ.v network_out_len /\
                ...
                (exists outer_fragment.
                   ...
                   R.seal
                     ...
                     Some (outer_fragment, R.next_seq (Ghost.reveal record_write)))))
{
  c_stub_serialize_protected_handshake_record
    #msg
    write_state
    handshake
    handshake_len
...
assume val c_stub_serialize_server_hello_from_selection :
      ...
      exists* out_bytes.
        ...
        pure (B.length out_bytes == 90 /\
              ...
              WS.parse_tls_message T.Handshake out_bytes ==
                Some (M.TlsHandshake (M.ServerHello (Ghost.reveal sh)))))

noextract fn serialize_server_hello_from_selection
  (#sh: erased M.server_hello)
  (lsh: L.server_hello)
  (out: array U8.t)
  (out_len: SZ.t)
  ...
  ensures exists* out_bytes.
          ...
          pure (B.length out_bytes == 90 /\
               ...
               WS.parse_tls_message T.Handshake out_bytes ==
                 Some (M.TlsHandshake (M.ServerHello (Ghost.reveal sh))))
{
  c_stub_serialize_server_hello_from_selection #sh lsh out out_len #old_bytes
}

assume val c_stub_serialize_server_hello_record_from_selection :
  (#sh: erased M.server_hello) ->
  lsh: L.server_hello ->
  out: array U8.t ->
  out_len: SZ.t ->
...
noextract fn serialize_server_hello_record_from_selection
  (#sh: erased M.server_hello)
  (lsh: L.server_hello)
  (out: array U8.t)
  (out_len: SZ.t)
  ...
  ensures exists* out_bytes.
          ...
          pure (B.length out_bytes == 95 /\
               ...
               CS.raw_records_exactly out_bytes T.Handshake 1)
{
  c_stub_serialize_server_hello_record_from_selection #sh lsh out out_len #old_bytes
}

assume val c_stub_serialize_empty_encrypted_extensions :
  out: array U8.t ->
  out_len: SZ.t ->
  (#old_bytes: erased B.bytes) ->
  stt
...
noextract fn serialize_empty_encrypted_extensions
  (out: array U8.t)
  (out_len: SZ.t)
  (#old_bytes: erased B.bytes)
  ...
  ensures exists* out_bytes.
          ...
          pure (B.length out_bytes == 6 /\
               ...
               WS.parse_tls_message T.Handshake out_bytes ==
                 Some (M.TlsHandshake (M.EncryptedExtensions { M.negotiated_alpn = None; M.body = out_bytes })))
{
  c_stub_serialize_empty_encrypted_extensions out out_len #old_bytes
}

assume val c_stub_serialize_certificate_from_credential :
    ...
    (fun written ->
      exists* out_bytes.
        ...
        pure (B.length out_bytes == SZ.v out_len /\
              ...
              WS.parse_tls_message T.Handshake out_bytes ==
                Some (M.TlsHandshake (M.Certificate (Ghost.reveal cert)))))

noextract fn serialize_certificate_from_credential
  (#cert: erased M.certificate_msg)
  (lcert: L.certificate_msg)
  (out: array U8.t)
  (out_len: SZ.t)
  ...
  ensures exists* out_bytes.
          ...
          pure (B.length out_bytes == SZ.v out_len /\
               ...
               WS.parse_tls_message T.Handshake out_bytes ==
                 Some (M.TlsHandshake (M.Certificate (Ghost.reveal cert))))
{
  c_stub_serialize_certificate_from_credential #cert lcert out out_len #old_bytes
}

assume val c_stub_serialize_certificate_verify_from_signature :
    ...
    (fun written ->
      exists* out_bytes.
        ...
        pure (B.length out_bytes == SZ.v out_len /\
              ...
              WS.parse_tls_message T.Handshake out_bytes ==
                Some (M.TlsHandshake (M.CertificateVerify (Ghost.reveal cv)))))

noextract fn serialize_certificate_verify_from_signature
  (#cv: erased M.certificate_verify)
  (lcv: L.certificate_verify)
  (out: array U8.t)
  (out_len: SZ.t)
  ...
  ensures exists* out_bytes.
          ...
          pure (B.length out_bytes == SZ.v out_len /\
               ...
               WS.parse_tls_message T.Handshake out_bytes ==
                 Some (M.TlsHandshake (M.CertificateVerify (Ghost.reveal cv))))
{
  c_stub_serialize_certificate_verify_from_signature #cv lcv out out_len #old_bytes
}

assume val c_stub_serialize_server_finished :
  (#fin: erased M.finished) ->
  lfin: L.finished ->
  out: array U8.t ->
  out_len: SZ.t ->
...
noextract fn serialize_server_finished
  (#fin: erased M.finished)
  (lfin: L.finished)
  (out: array U8.t)
  (out_len: SZ.t)
  ...
  ensures exists* out_bytes.
          ...
          pure (B.length out_bytes == 36 /\
               ...
               WS.parse_tls_message T.Handshake out_bytes ==
                 Some (M.TlsHandshake (M.Finished (Ghost.reveal fin))))
{
  c_stub_serialize_server_finished #fin lfin out out_len #old_bytes
}

            ...
            }))
{
  ...
  Rec.install_handshake_keys_runtime c.records.write traffic_key_src aead_key_len (Ghost.hide (Ghost.reveal material).CS.traffic_key) traffic_iv_src;
            ...
            }))
{
  ...
  Rec.install_handshake_keys_runtime c.records.read traffic_key_src aead_key_len (Ghost.hide (Ghost.reveal material).CS.traffic_key) traffic_iv_src;
  assert (pure ((Ghost.reveal install).CS.install_epoch == CS.TrafficHandshake));
            ...
            }))
{
  ...
  Rec.install_application_keys_runtime c.records.write traffic_key_src aead_key_len (Ghost.hide (Ghost.reveal material).CS.traffic_key) traffic_iv_src;
            ...
            }))
{
  ...
  Rec.install_application_keys_runtime c.records.read traffic_key_src aead_key_len (Ghost.hide (Ghost.reveal material).CS.traffic_key) traffic_iv_src;
  assert (pure ((Ghost.reveal install).CS.install_epoch == CS.TrafficApplication));
  assert (pure ((Ghost.reveal install).CS.install_direction == CS.TrafficRead));
  assert (pure ((Ghost.reveal install).CS.install_material == Ghost.reveal material));
  assert (pure ((Ghost.reveal role_install).CS.install_role == CS.ServerEndpoint));
              ...
              }))
{
  ...
  let material = Ghost.hide (CS.traffic_key_material_for_secret (TLS13.Crypto.Spec.aead_alg_of_key_len (SZ.v aead_key_len)) (Ghost.reveal traffic_secret));
             ...
             connection_exactly c st0)
{
  ...
  if ready {
    ...
    Rec.install_handshake_keys_runtime c.records.write traffic_key_out aead_key_len (Ghost.hide (Ghost.reveal material).CS.traffic_key) traffic_iv_out;
    assert (pure ((Ghost.reveal install).CS.install_epoch == CS.TrafficHandshake));
    assert (pure ((Ghost.reveal install).CS.install_direction == CS.TrafficWrite));
    assert (pure ((Ghost.reveal install).CS.install_material == Ghost.reveal material));
             ...
             connection_exactly c st0)
{
  ...
  if ready {
    ...
    Rec.install_handshake_keys_runtime c.records.read traffic_key_out aead_key_len (Ghost.hide (Ghost.reveal material).CS.traffic_key) traffic_iv_out;
    assert (pure ((Ghost.reveal install).CS.install_epoch == CS.TrafficHandshake));
    assert (pure ((Ghost.reveal install).CS.install_direction == CS.TrafficRead));
    assert (pure ((Ghost.reveal install).CS.install_material == Ghost.reveal material));
    assert (pure ((installed_traffic_keys_state st0 (Ghost.reveal install)).CS.cs_model.CS.model_record.CS.record_write ==

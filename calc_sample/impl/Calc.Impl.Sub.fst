...
(** Process a Sub request: pop two operands, push (wrapping) second - top. **)
  ...
  )
{
  ...
  if SZ.gte csz 2sz {
    // Sub success: pop two, push wrapping (second - top)
    ...
    let result = U32.sub_mod v_second v_top;                       // sub_mod y x, as in step

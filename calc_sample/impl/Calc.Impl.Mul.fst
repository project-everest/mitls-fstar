...
(** Process a Mul request: pop two operands, push their (wrapping) product. **)
  ...
  )
{
  ...
  if SZ.gte csz 2sz {
    // Mul success: pop two, push wrapping product
    ...
    let result = U32.mul_mod v_top v_second;                       // mul_mod x y, as in step

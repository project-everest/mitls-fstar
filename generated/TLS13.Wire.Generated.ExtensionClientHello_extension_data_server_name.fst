...
let extensionClientHello_extension_data_server_name_parser = LP.parse_synth extensionClientHello_extension_data_server_name'_parser synth_extensionClientHello_extension_data_server_name

noextract let extensionClientHello_extension_data_server_name'_serializer : LP.serializer extensionClientHello_extension_data_server_name'_parser =
  LP.serialize_bounded_vldata_strong 0 65535 serverNameList_serializer

let extensionClientHello_extension_data_server_name_serializer = LP.serialize_synth _ synth_extensionClientHello_extension_data_server_name extensionClientHello_extension_data_server_name'_serializer synth_extensionClientHello_extension_data_server_name_recip ()
...
let extensionClientHello_extension_data_server_name_accessor =
  PPC.accessor_ext
...
let extensionClientHello_extension_data_server_name_copyful_synth_injective () : Lemma (LP.synth_injective synth_extensionClientHello_extension_data_server_name) = ()

let extensionClientHello_extension_data_server_name_copyful_synth_inverse () : Lemma (LP.synth_inverse synth_extensionClientHello_extension_data_server_name synth_extensionClientHello_extension_data_server_name_recip) = ()

let read_extensionClientHello_extension_data_server_name : PPB.copyful_parse extensionClientHello_extension_data_server_name_vmatch extensionClientHello_extension_data_server_name_parser extensionClientHello_extension_data_server_name_conv =
...
let free_extensionClientHello_extension_data_server_name : PPB.free_t extensionClientHello_extension_data_server_name_vmatch =
  PPVD.free_vldata_strong 0 65535 serverNameList_serializer free_serverNameList

let write_extensionClientHello_extension_data_server_name : PPB.l2r_safe_writer extensionClientHello_extension_data_server_name_vmatch extensionClientHello_extension_data_server_name_serializer extensionClientHello_extension_data_server_name_conv =
  extensionClientHello_extension_data_server_name_copyful_synth_injective ();
  extensionClientHello_extension_data_server_name_copyful_synth_inverse ();
...
let extensionClientHello_extension_data_server_name_bytesize_eqn x =
  LP.serialize_synth_eq _ synth_extensionClientHello_extension_data_server_name extensionClientHello_extension_data_server_name'_serializer synth_extensionClientHello_extension_data_server_name_recip () x;
  (serverNameList_bytesize_eq (x))

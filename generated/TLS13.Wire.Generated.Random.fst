...
let random_bytesize_eq x = ()

let random_bytesize_eqn x = ()

let read_random = LSeqB.copyful_parse_seq_flbytes 32

let free_random : PPB.free_t random_vmatch = fun x #v -> LSeqB.free_copy_seqbytes x #(Ghost.hide (Ghost.reveal v <: Seq.seq FStar.UInt8.t))

let write_random = LSeqB.l2r_safe_writer_seq_flbytes 32 32sz

let size_random = LSeqB.l2r_safe_size_seq_flbytes 32 32sz

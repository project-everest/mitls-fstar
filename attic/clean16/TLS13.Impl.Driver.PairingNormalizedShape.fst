...
let lemma_client_server_application_record_material_agrees_from_normalized_replay_shape
  ...
  : Lemma
      ...
      (ensures
        ...
        CS.peer_record_material_agrees
          ...
          server)
=
  lemma_client_server_application_record_material_agrees_from_normalized_replay_shape
    client
    server

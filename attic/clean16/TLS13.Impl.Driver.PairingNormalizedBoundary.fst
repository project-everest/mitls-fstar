...
let lemma_client_server_application_record_material_agrees_from_normalized_replay_boundary
...
=
  ...
  ( eliminate exists
      ...
      WFL.supported_client_hello_wire_profile w.PCB.hcb_client_ch /\
      ...
      CS.cleartext_tls_message_raw
        (M.TlsHandshake (M.ClientHello w.PCB.hcb_client_ch))
        w.PCB.hcb_client_ch_raw /\
      CS.received_cleartext_tls_message_raw
        (M.TlsHandshake (M.ClientHello w.PCB.hcb_server_ch))
        w.PCB.hcb_server_ch_raw /\
      CS.cleartext_tls_message_raw
        (M.TlsHandshake (M.ServerHello w.PCB.hcb_server_sh))
      ...
      PWL.paired_protected_handshake_contiguous_replay_views
        ...
        client.CS.cs_model
    with
    ( PR.lemma_client_server_application_record_material_agrees_from_cleartext_raw_and_contiguous_replay_views
          client
          server
          w.PCB.hcb_client_ch
        w.PCB.hcb_server_ch

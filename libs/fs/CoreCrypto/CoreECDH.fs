...
let secp384r1 =
    let p384 = new BigInteger("39402006196394479212279040100143613805079739270465446667948293404245721771496870329047266088258938001861606973112319", 10)
    let curve =
        new FpCurve(p384,
    ...
    let basepx = new FpFieldElement(p384, new BigInteger("aa87ca22be8b05378eb1c71ef320ad746e1d3b628ba79b9859f741e082542a385502f25dbf55296c3a545e3872760ab7", 16))
    let basepy = new FpFieldElement(p384, new BigInteger("3617de4a96262c6f5d9e98bf9292dc29f8f41dbd289a147ce9da3113b5f0b8c00a60b1ce1d7e819d7a431d7c90ea0e5f", 16))
    let basep = new FpPoint(curve, basepx, basepy)

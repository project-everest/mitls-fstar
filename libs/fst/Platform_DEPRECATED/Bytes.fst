(* DEPRECATED : MK : moved to FStar/contrib/Platform/fst *)
...
val split: b:bytes -> n:nat{n <= Seq.length b} -> Tot (lbytes n * lbytes (length b - n))
...
assume val split2 : b:bytes -> n1:nat -> n2:nat -> Tot (lbytes n1 * lbytes n2 * lbytes (length b - n1 - n2))

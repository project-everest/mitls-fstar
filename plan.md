...
1. `tls13_connection_probe.c`
   - Raw socket orchestration, encrypted-record read/append, transcript byte storage, OpenSSL peer handle storage, application read/write loop scaffolding, and the remaining backend handle for the extracted connection.

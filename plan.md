...
1. `tls13_connection_probe.c`
   ...
   - Remaining TLS-owned work to replace: ServerHello/key-derivation glue, encrypted-handshake body parser accept hooks, application-read handling of handshake records/receive-side alerts, padding, and fragmentation handling.

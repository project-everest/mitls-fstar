...
2. `tls13_wire_stubs.c`
   ...
   - Replaced in the wrapper path so far: record header write/read, TLSInnerPlaintext no-padding write/read, handshake header parse, CertificateVerify input construction, and CertificateVerify body scheme/signature-length parsing.

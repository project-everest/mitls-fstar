...
6. [in progress] Add Pulse `.fsti` contracts and C stubs for HACL*, OpenSSL, parser/serializer, randomness, clock, and I/O. Initial Pulse interfaces and placeholder C stub files are present and verify/compile-syntax; HACL* C snapshot wrappers for SHA-256, HMAC-SHA256, HKDF-SHA256, X25519, ChaCha20-Poly1305, and random bytes are started with C vector tests for SHA-256/HMAC/HKDF. Remaining work is extracted-name wiring, OpenSSL/wire/I/O implementations, and broader vectors.

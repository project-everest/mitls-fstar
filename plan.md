...
The next highest-value implementation step is to add application-read padding/fragmentation behavior, then audit the remaining `tls13_connection_probe.c` backend down to raw transport, HACL*/OpenSSL boundaries, and small extraction support shims.

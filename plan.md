...
1. `tls13_connection_probe.c`
   ...
   - Remaining TLS-owned work to replace: initial ServerHello exact-read path, encrypted-handshake body parser accept hooks, application-read handling of handshake records/receive-side alerts, padding, and fragmentation handling.

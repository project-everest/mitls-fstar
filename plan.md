...
1. `tls13_connection_probe.c`
   ...
   - Remaining TLS-owned work to replace: encrypted-handshake buffering/copy helper shape, C exact-read loops still used by the handshake path, application-read handling of handshake records/receive-side alerts, padding, and fragmentation handling.
